...
<style>
    ...
    .active-nav{
        background-color: rgba(33, 33, 33, 0.584);
    }
...
<?php if($_SESSION['Rule'] == 'admin'){?>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="list-unstyled components">
            <li class="" class="<?php ($url_actuel == 'dashboard.php' ? 'active-nav' : '') ?>">
            ...
            <li class="dropdown">
            <a href="users/index.php"  class="<?php ($url_actuel == 'stage/users' ? 'active-nav' : '') ?>" data-toggle="collapse" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i>
                <span>users</span>
...
<?php if($_SESSION['Rule'] == 'encadreur'){?>
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="list-unstyled components">
            <li  class="<?php echo ($url_actuel == '/stage' ? 'active-nav' : '') ?>"">
                <a href="#" class="dashboard"> <i class="fa fa-dashboard" aria-hidden="true"></i>
                <span>dashboard</span></a>
            </li>
            <div class="small-screen navbar-display">
