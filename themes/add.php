                    ...
                    <div class="col-md-5 border-right">
                                    <div class="p-3 py-5">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="text-right">Add themes</h4>
                                        </div>
                                        <div class="row mt-3">
       
                                            <div class="col-md-12"><label class="labels" >nom_theme</label><input type="text" class="form-control" placeholder="nom_theme"  name="nom_theme"></div>
                                            <div class="col-md-12"><label class="labels" >description</label><input type="text" class="form-control" placeholder="description" name="des_themes"></div>
