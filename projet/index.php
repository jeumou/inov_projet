                    ...
                    <div class="card-content table responsive">
                            <div class="table-responsive">
                                ...
                                <?php
                                    ...
                                    $sql2="SELECT * FROM equipe, projet WHERE projet.id_equipe=equipe.id_equipe";
                                        ...
                                        while($row2=$result2->fetch(PDO::FETCH_ASSOC)){?>
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    ...
                                                    <a href="edit.php?id=<?php echo $row2["ID_PROJET"]?>" class="m-2"><i class="fa fa-pencil text-primary" aria-hidden="true"></i></a>
                                                    <a href="delete.php?id=<?php echo $row2["ID_PROJET"]?>" class="m-2"><i class="fa fa-archive text-danger" aria-hidden="true"></i></a>
                                                </th>
